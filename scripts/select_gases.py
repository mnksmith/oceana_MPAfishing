...
#select all MPAs containing submarine structures made by leaking gases (1180)
...
with fiona.open("natura2000_utf8.shp") as source:
	...
	with fiona.open('gases_habitats.shp', 'w', encoding='utf-8', **source.meta) as outfile:
...
#			print sitecode
#			print habitatcodes
			if ('1180' in habitatcodes.values) and (sitetype != 'A'):
				poly['properties']['SITENAME'] = 'PLACEHOLDER'
				outfile.write(poly)
				print(str(i) + ' Gases Site Code: ' + sitecode)
			if i%100==0:
				print(i)
