...
gfw_data = pd.read_csv("~/EUeez_allfishing_Mar18.csv")

#read in extra data
site_data = pd.read_csv("~/NATURA2000SITES.csv")
hab_data = pd.read_csv("~/HABITATS.csv")
vessel_data = pd.read_csv("~/EU_fleet_register.csv")
