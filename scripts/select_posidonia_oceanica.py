...
#select all MPAs containing posidonia oceanica beds (1120)
...
with fiona.open("natura2000_utf8.shp") as source:
	...
	with fiona.open('posidonia_habitats.shp', 'w', encoding='utf-8', **source.meta) as outfile:
...
#			print sitecode
#			print habitatcodes
			if ('1120' in habitatcodes.values) and (sitetype != 'A'):
				poly['properties']['SITENAME'] = 'PLACEHOLDER'
				outfile.write(poly)
				print(str(i) + ' Posidonia Oceanica Site Code: ' + sitecode)
			if i%100==0:
				print(i)
