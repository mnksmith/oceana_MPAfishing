...
#select all MPAs containing sandbanks or estuaries (1110, 1130)
...
with fiona.open("natura2000_utf8.shp") as source:
	...
	with fiona.open('estuaries_habitats.shp', 'w', encoding='utf-8', **source.meta) as outfile:
...
#			print sitecode
#			print habitatcodes
			if (('1130' in habitatcodes.values) and (sitetype != 'A')):
				poly['properties']['SITENAME'] = 'PLACEHOLDER'
				outfile.write(poly)
				print(str(i) + ' Estuaries Site Code: ' + sitecode)
			if i%100==0:
				print(i)
