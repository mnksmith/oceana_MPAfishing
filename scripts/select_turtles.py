...
with fiona.open("natura2000_utf8.shp") as source:
	...
	with fiona.open('turtle_habitats.shp', 'w', encoding='utf-8', **source.meta) as outfile:
		...
		for i, poly in enumerate(polygons):
			...
			if ('1224' in speciescodes.values or '1227' in speciescodes.values) and (sitetype != 'A'):
				poly['properties']['SITENAME'] = 'PLACEHOLDER'
				outfile.write(poly)
				print(str(i) + ' Turtle Site Code: ' + sitecode + str(speciescodes.values))
			if i%100==0:
				print(i)
