...
#select all MPAs containing mudflats or coastal lagoons (1140, 1150)
...
with fiona.open("natura2000_utf8.shp") as source:
	...
	with fiona.open('lagoons_habitats.shp', 'w', encoding='utf-8', **source.meta) as outfile:
...
#			print sitecode
#			print habitatcodes
			if ('1150' in habitatcodes.values) and (sitetype != 'A'):
				poly['properties']['SITENAME'] = 'PLACEHOLDER'
				outfile.write(poly)
				print(str(i) + ' Lagoon Site Code: ' + sitecode)
			if i%100==0:
				print(i)
